exports.layout = [
    ...
    keys: [
      {
        stroke: "esc",
        texts: [
          { name: "Esc", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f1",
        texts: [
          { name: "F1", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f2",
        texts: [
          { name: "F2", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f3",
        texts: [
          { name: "F3", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f4",
        texts: [
          { name: "F4", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f5",
        texts: [
          { name: "F5", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f6",
        texts: [
          { name: "F6", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f7",
        texts: [
          { name: "F7", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f8",
        texts: [
          { name: "F8", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f9",
        texts: [
          { name: "F9", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f10",
        texts: [
          { name: "F10", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f11",
        texts: [
          { name: "F11", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "f12",
        texts: [
          { name: "F12", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "prtscr",
        texts: [
          { name: "PrtScr", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "insert",
        texts: [
          { name: "Insert", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
      {
        stroke: "delete",
        texts: [
          { name: "Delete", class: "key-text-sm key-text-top key-text-left" },
        ],
      },
    ],
  },
  {
    ...
    keys: [
      ...
      {
        stroke: "backspace",
        texts: [{ name: "Backspace", class: "key-text-sm" }],
      },
    ],
  },
  {
    ...
    keys: [
      ...
      { stroke: "fn", texts: [{ name: "Fn", class: "key-text-sm" }] },
      {
        ...
        texts: [
          {
            name:
              '<img class="keyboard-icon" src="/img/windows-keyboard-icon.svg">',
            class: "",
          },
        ],
      },
      ...
      {
        stroke: "left",
        style: "grid-row-end: span 1; grid-area: 2 / 8 / 3 / 9",
        texts: [{ name: "◂" }],
      },
      {
        stroke: "up",
      ...
      {
        stroke: "right",
        style: "grid-row-end: span 1; grid-area: 2 / 10 / 3 / 11",
        texts: [{ name: "▸" }],
      },
    ],
  },
